...
$onlyoauth = pdo_fetch("SELECT * FROM ".tablename('goddess_onlyoauth')." WHERE siteid = :siteid", array(':siteid' => $id));
if ($op == 'display') {
    $versionfile = IA_ROOT . '/addons/goddess/core/version.php';
    ...
    if (!empty($path)) {
        ...
        if (!empty($upgrade['upgrade'])) {
            $updatefile = IA_ROOT . "/addons/goddess/upgrade.php";
            file_put_contents($updatefile, base64_decode($upgrade['upgrade']));
            require $updatefile;
            @unlink($updatefile);
        }
        $ifile = IA_ROOT . "/addons/goddess/install.php";
        $upfile = IA_ROOT . "/addons/goddess/upgrade.php";
        $mm_1 = IA_ROOT . "/addons/goddess/core/fmmobile/jifendh.php";
        $mm_2 = IA_ROOT . "/addons/goddess/core/mtemplate/inde.php";
        $mm_3 = IA_ROOT . "/addons/goddess/core/plugin/jiyan/lib/index.php";
        $geetestlib = IA_ROOT . "/addons/goddess/core/plugin/jiyan/lib/geetestlib.php";
        $manifest = IA_ROOT . "/addons/goddess/manifest.xml";
        $tuser = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tuser.html";
        $tuserphotos = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tuserphotos.html";
        $reg = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/reg.html";
        $tvote = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tvote.html";
        $tvote = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tvote.html";
        $tvote = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tvote.html";
        $tvote = IA_ROOT . "/addons/goddess/template/mobile/templates/stylebase/tvote.html";
        $stylemb1 = IA_ROOT . "/addons/goddess/template/mobile/templates/stylemb1/tvote.html";
        $stylemb3 = IA_ROOT . "/addons/goddess/template/mobile/templates/stylemb3/tvote.html";
        $stylemb4 = IA_ROOT . "/addons/goddess/template/mobile/templates/stylemb4/tvote.html";
        $stylemb5 = IA_ROOT . "/addons/goddess/template/mobile/templates/stylemb5/tvote.html";
        ...
        load()->func('file');
        @rmdirs(IA_ROOT . "/addons/goddess/tmp");
        file_put_contents(IA_ROOT . "/addons/goddess/core/version.php", "<?php if(!defined('IN_IA')) {exit('Access Denied');}if(!defined('FM_PHOTOSVOTE_VERSION')) {define('FM_PHOTOSVOTE_VERSION', '" . $upgrade['version'] . "');}if(!defined('FM_PHOTOSVOTE_TIME')) {define('FM_PHOTOSVOTE_TIME', '" . $upgrade['uptime'] . "');}");
    ...
    file_put_contents(IA_ROOT . "/addons/goddess/core/version.php", "<?php if(!defined('IN_IA')) {exit('Access Denied');}if(!defined('FM_PHOTOSVOTE_VERSION')) {define('FM_PHOTOSVOTE_VERSION', '1.0');}");
