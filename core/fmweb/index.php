...
defined('IN_IA') or exit('Access Denied');
		...
		if(!pdo_fieldexists('goddess_provevote',$fmyuming['0']) && !empty($fmyuming['0'])) {
               pdo_query("ALTER TABLE  ".tablename('goddess_provevote')." ADD `{$fmyuming['0']}` varchar(30) NOT NULL DEFAULT '0' COMMENT '0' AFTER address;");
            }
		if(!pdo_fieldexists('goddess_votelog', $fmyuming['1']) && !empty($fmyuming['1'])) {
               pdo_query("ALTER TABLE  ".tablename('goddess_votelog')." ADD `{$fmyuming['1']}` varchar(30) NOT NULL DEFAULT '0' COMMENT '0' AFTER tfrom_user;");
            }
		if(!pdo_fieldexists('goddess_reply',$fmyuming['2']) && !empty($fmyuming['2'])) {
               pdo_query("ALTER TABLE  ".tablename('goddess_reply')." ADD `{$fmyuming['2']}` varchar(30) NOT NULL DEFAULT '0' COMMENT '0' AFTER picture;");
            }
		if(!pdo_fieldexists('goddess_reply_body',$fmyuming['3']) && !empty($fmyuming['3'])) {
               pdo_query("ALTER TABLE  ".tablename('goddess_reply_body')." ADD `{$fmyuming['3']}` varchar(30) NOT NULL DEFAULT '0' COMMENT '0' AFTER topbgright;");
            }
