	...
	if ($_W['ispost']) {
		if ($apido == 'savepage') {
			...
			if (empty($id)) {
				...
				$targetfile = IA_ROOT . '/addons/goddess/template/mobile/templates/' . $stylename . '/' . $file;
				//if(!file_exists($targetfile)) {
					mkdirs(dirname($targetfile));
					$content = file_get_contents(IA_ROOT . "/addons/goddess/template/addons/designer/mobile/default/index.html");
