...
defined('IN_IA') or exit('Access Denied');
		 ...
		 * 显示上传的头像和视频首图
		 */
		$head_img = pdo_get('goddess_provevote_headarr',array('from_user'=>$from_user,'rid'=>$rid,'head_img'=>1))['photos'];
		$video_img = pdo_get('goddess_provevote_headarr',array('from_user'=>$from_user,'rid'=>$rid,'head_img'=>2))['photos'];
